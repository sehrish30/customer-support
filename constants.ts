...
export const GITHUB_SEARCH_SIGNALS = [
  ...
  /\b(found a bug|experiencing (a |an )?bug|getting an error|not working|doesn'?t work|broken|crash(ing)?|fails?|unsuccessful|failed|not (loading|showing|displaying)|won'?t (load|open|work))\b/i,
];
